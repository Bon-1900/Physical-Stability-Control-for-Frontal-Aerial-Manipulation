...
%% set path
path_pos_baseline     = "./exp1.2.4_baseline/exp1.2.4_baseline_vehicle_local_position_0.csv";

path_pos_rw0_00_fw0_225 = "./exp1.2.4_rw0.00_fw0.225/exp1.2.4_rw0.00_fw0.225_vehicle_local_position_0.csv";

path_pos_rw0_05_fw0_25  = "./exp1.2.4_rw0.05_fw0.25/exp1.2.4_rw0.05_fw0.25_vehicle_local_position_0.csv";
path_pos_rw0_05_fw0_30  = "./exp1.2.4_rw0.05_fw0.30/exp1.2.4_rw0.05_fw0.30_vehicle_local_position_0.csv";

path_pos_rw0_10_fw0_30  = "./exp1.2.4_rw0.10_fw0.30/exp1.2.4_rw0.10_fw0.30_vehicle_local_position_0.csv";
path_pos_rw0_10_fw0_35  = "./exp1.2.4_rw0.10_fw0.35/exp1.2.4_rw0.10_fw0.35_vehicle_local_position_0.csv";

path_pos_rw0_15_fw0_40  = "./exp1.2.4_rw0.15_fw0.40/exp1.2.4_rw0.15_fw0.40_vehicle_local_position_0.csv";
path_pos_rw0_15_fw0_45  = "./exp1.2.4_rw0.15_fw0.45/exp1.2.4_rw0.15_fw0.45_vehicle_local_position_0.csv";

path_pos_rw0_20_fw0_45  = "./exp1.2.4_rw0.20_fw0.45/exp1.2.4_rw0.20_fw0.45_vehicle_local_position_0.csv";
path_pos_rw0_20_fw0_50  = "./exp1.2.4_rw0.20_fw0.50/exp1.2.4_rw0.20_fw0.50_vehicle_local_position_0.csv";

path_pos_rw0_25_fw0_55  = "./exp1.2.4_rw0.25_fw0.55/exp1.2.4_rw0.25_fw0.55_vehicle_local_position_0.csv";
path_pos_rw0_25_fw0_60  = "./exp1.2.4_rw0.25_fw0.60/exp1.2.4_rw0.25_fw0.60_vehicle_local_position_0.csv";

path_pos_rw0_29_fw0_66  = "./exp1.2.4_rw0.29_fw0.66/exp1.2.4_rw0.29_fw0.66_vehicle_local_position_0.csv";

% setpoints data path
path_pos_sp_baseline  = "./exp1.2.4_baseline/exp1.2.4_baseline_vehicle_local_position_setpoint_0.csv";

path_pos_sp_rw0_00_fw0_225 = "./exp1.2.4_rw0.00_fw0.225/exp1.2.4_rw0.00_fw0.225_vehicle_local_position_setpoint_0.csv";

path_pos_sp_rw0_05_fw0_25  = "./exp1.2.4_rw0.05_fw0.25/exp1.2.4_rw0.05_fw0.25_vehicle_local_position_setpoint_0.csv";
path_pos_sp_rw0_05_fw0_30  = "./exp1.2.4_rw0.05_fw0.30/exp1.2.4_rw0.05_fw0.30_vehicle_local_position_setpoint_0.csv";

path_pos_sp_rw0_10_fw0_30  = "./exp1.2.4_rw0.10_fw0.30/exp1.2.4_rw0.10_fw0.30_vehicle_local_position_setpoint_0.csv";
path_pos_sp_rw0_10_fw0_35  = "./exp1.2.4_rw0.10_fw0.35/exp1.2.4_rw0.10_fw0.35_vehicle_local_position_setpoint_0.csv";

path_pos_sp_rw0_15_fw0_40  = "./exp1.2.4_rw0.15_fw0.40/exp1.2.4_rw0.15_fw0.40_vehicle_local_position_setpoint_0.csv";
path_pos_sp_rw0_15_fw0_45  = "./exp1.2.4_rw0.15_fw0.45/exp1.2.4_rw0.15_fw0.45_vehicle_local_position_setpoint_0.csv";

path_pos_sp_rw0_20_fw0_45  = "./exp1.2.4_rw0.20_fw0.45/exp1.2.4_rw0.20_fw0.45_vehicle_local_position_setpoint_0.csv";
path_pos_sp_rw0_20_fw0_50  = "./exp1.2.4_rw0.20_fw0.50/exp1.2.4_rw0.20_fw0.50_vehicle_local_position_setpoint_0.csv";

path_pos_sp_rw0_25_fw0_55  = "./exp1.2.4_rw0.25_fw0.55/exp1.2.4_rw0.25_fw0.55_vehicle_local_position_setpoint_0.csv";
path_pos_sp_rw0_25_fw0_60  = "./exp1.2.4_rw0.25_fw0.60/exp1.2.4_rw0.25_fw0.60_vehicle_local_position_setpoint_0.csv";

path_pos_sp_rw0_29_fw0_66  = "./exp1.2.4_rw0.29_fw0.66/exp1.2.4_rw0.29_fw0.66_vehicle_local_position_setpoint_0.csv";
...
sgtitle('Exp1.2.4 Position Data')
...
saveas(gcf,'Plots/exp1.2.4_xyz_plot.jpg')


%% Plot transitional error
f_err = figure;
f_err.Position = [468   169   892   692];
sgtitle ('Exp1.2.4 Absolute Translational error')
for i_plot=1:6
    subplot(3,2,i_plot)
    hold on
    grid on
...
saveas(gcf,'Plots/exp1.2.4_err_plot.jpg')
