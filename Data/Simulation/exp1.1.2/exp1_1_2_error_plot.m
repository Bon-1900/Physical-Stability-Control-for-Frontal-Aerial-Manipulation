...
%% set path
path_pos_baseline     = "./exp1.1.2_baseline/exp1.1.2_baseline_vehicle_local_position_0.csv";
path_pos_sp_baseline  = "./exp1.1.2_baseline/exp1.1.2_baseline_vehicle_local_position_setpoint_0.csv";

path_pos_w1_0       = "./exp1.1.2_W1.0/exp1.1.2_W1.0_vehicle_local_position_0.csv";
path_pos_sp_w1_0    = "./exp1.1.2_W1.0/exp1.1.2_W1.0_vehicle_local_position_setpoint_0.csv";

path_pos_w1_1       = "./exp1.1.2_W1.1/exp1.1.2_W1.1_vehicle_local_position_0.csv";
path_pos_sp_w1_1    = "./exp1.1.2_W1.1/exp1.1.2_W1.1_vehicle_local_position_setpoint_0.csv";

path_pos_w1_2       = "./exp1.1.2_W1.2/exp1.1.2_W1.2_vehicle_local_position_0.csv";
path_pos_sp_w1_2    = "./exp1.1.2_W1.2/exp1.1.2_W1.2_vehicle_local_position_setpoint_0.csv";

path_pos_w1_25      = "./exp1.1.2_W1.25/exp1.1.2_W1.25_vehicle_local_position_0.csv";
path_pos_sp_w1_25   = "./exp1.1.2_W1.25/exp1.1.2_W1.25_vehicle_local_position_setpoint_0.csv";

path_pos_w1_3       = "./exp1.1.2_W1.3/exp1.1.2_W1.3_vehicle_local_position_0.csv";
path_pos_sp_w1_3    = "./exp1.1.2_W1.3/exp1.1.2_W1.3_vehicle_local_position_setpoint_0.csv";
...
%% Plot xyz positions
figure
sgtitle('Exp1.1.2 Position Data')
for i_xyz=1:3
    subplot(3,1,i_xyz)
    hold on
    grid on
...
saveas(gcf,'Plots/exp1.1.2_xyz_plot.jpg')

%% Plot xyz positions (stable)
figure
sgtitle('Exp1.1.2 Position Data (Stable Scenarios)')
for i_xyz=1:3
    subplot(3,1,i_xyz)
    hold on
    grid on
...
saveas(gcf,'Plots/exp1.1.2_xyz_stable_plot.jpg')
...
xlabel('Simulation Time (sec)')
ylabel('Error (m)')
title ('exp1.1.2 Absolute Translational error')
saveas(gcf,'Plots/exp1.1.2_err_plot.jpg')
...
xlabel('Simulation Time (sec)')
ylabel('Error (m)')
title ('exp1.1.2 Absolute Translational error (Stable Scenarios)')
saveas(gcf,'Plots/exp1.1.2_err_stable_plot.jpg')
