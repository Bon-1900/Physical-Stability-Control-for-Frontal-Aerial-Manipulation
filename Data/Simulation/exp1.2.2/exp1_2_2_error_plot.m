...
%% set path
path_pos_baseline     = "./exp1.2.2_baseline/exp1.2.2_baseline_vehicle_local_position_0.csv";
path_pos_sp_baseline  = "./exp1.2.2_baseline/exp1.2.2_baseline_vehicle_local_position_setpoint_0.csv";

path_pos_w0_1       = "./exp1.2.2_w0.1/exp1.2.2_w0.1_vehicle_local_position_0.csv";
path_pos_sp_w0_1    = "./exp1.2.2_w0.1/exp1.2.2_w0.1_vehicle_local_position_setpoint_0.csv";

path_pos_w0_2       = "./exp1.2.2_w0.2/exp1.2.2_w0.2_vehicle_local_position_0.csv";
path_pos_sp_w0_2    = "./exp1.2.2_w0.2/exp1.2.2_w0.2_vehicle_local_position_setpoint_0.csv";

path_pos_w0_225       = "./exp1.2.2_w0.225/exp1.2.2_w0.225_vehicle_local_position_0.csv";
path_pos_sp_w0_225    = "./exp1.2.2_w0.225/exp1.2.2_w0.225_vehicle_local_position_setpoint_0.csv";

path_pos_w0_25      = "./exp1.2.2_w0.25/exp1.2.2_w0.25_vehicle_local_position_0.csv";
path_pos_sp_w0_25   = "./exp1.2.2_w0.25/exp1.2.2_w0.25_vehicle_local_position_setpoint_0.csv";
...
%% Plot xyz positions
figure
sgtitle('Exp1.2.2 Position Data')
for i_xyz=1:3
    subplot(3,1,i_xyz)
    hold on
    grid on
...
saveas(gcf,'Plots/exp1.2.2_xyz_plot.jpg')

%% Plot xyz positions (stable)
figure
sgtitle('Exp1.2.2 Position Data (Stable Scenarios)')
for i_xyz=1:3
    subplot(3,1,i_xyz)
    hold on
    grid on
...
saveas(gcf,'Plots/exp1.2.2_xyz_stable_plot.jpg')
...
xlabel('Simulation Time (sec)')
ylabel('Error (m)')
title ('exp1.2.2 Absolute Translational error')
xlim([t_start, t_end])
saveas(gcf,'Plots/exp1.2.2_err_plot.jpg')
...
xlabel('Simulation Time (sec)')
ylabel('Error (m)')
title ('exp1.2.2 Absolute Translational error (Stable Scenarios)')
xlim([t_start, t_end])
saveas(gcf,'Plots/exp1.2.2_err_stable_plot.jpg')
